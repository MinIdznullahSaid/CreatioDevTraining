namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateRealtyAveragePriceMethodsWrapper

	/// <exclude/>
	public class UsrCalculateRealtyAveragePriceMethodsWrapper : ProcessModel
	{

		public UsrCalculateRealtyAveragePriceMethodsWrapper(Process process)
			: base(process) {
